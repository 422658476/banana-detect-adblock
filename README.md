...
并且规则列表中如果只是链接只增不减，增加的维护时间可能只有一点点，但如果发现其他的规则也出现只增不减的现象，那么这些维护者需要花费的维护时间和精力将会出现陡然增长(还记得我们的最终目的吗)，为什么:
...
没有错，他们正在犯一个你一开始就在犯的错误:想用一段完美的代码搞定对方。

这会产生什么问题:特例规则越多，各种规则之间会产生冲突和矛盾也越多。
...
不是决战紫禁之巅吗，不是生死存亡一线间吗？结果怎么又是风流盲侠站着太高，一脚踩空摔了下去……

有些人可能开始需要看心理医生了……心理医生？这个大家都熟悉:在治一个就可以买mini cooper啦。
